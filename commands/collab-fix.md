...
- you should first expand the problem to add context to a description that all agents can understand. Don't intepret $ARGUMENTS on your own but copy it verbatim.
...
5. Review their reponses; if any item depends on human preference, ask me (use `AskUserQuestion`).
